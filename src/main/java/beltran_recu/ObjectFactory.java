 ...
 * generated in the beltran_recu package. 
...
public class ObjectFactory {
    ...
    private static final QName _CalcularMasa_QNAME = new QName("http://beltran_recu/", "calcularMasa");
    private static final QName _CalcularMasaResponse_QNAME = new QName("http://beltran_recu/", "calcularMasaResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: beltran_recu
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://beltran_recu/", name = "calcularMasa")
     ...
     */
    @XmlElementDecl(namespace = "http://beltran_recu/", name = "calcularMasaResponse")
